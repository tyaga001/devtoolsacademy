...
![twilio vs stream confusion](/images/twilio-vs-stream.png)

## Architecture and Scalability

**Stream architecture  :**  

you can say stream is a wrapper on **distributed event-driven architecture** optimized for high scale and low latency  **.** stream’s architecture design uses message queues and distributed data stores for managing the high-troughput communication , ensuring real-time delivery and synchronisation accross users .
