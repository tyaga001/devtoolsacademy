...
Stream is mostly used for in-app chat use cases, use cases like [social apps](https://getstream.io/chat/solutions/social/) or [e-commerce](https://getstream.io/chat/solutions/marketplaces/), and [gaming](https://getstream.io/chat/solutions/gaming/) applications. Twilio is good when it comes to a multi-modal communication API provider.
...
open the Stream dashboard and copy the environment variables
...
⚠️ make sure you are setting up environment variables by creating `.env.developement` file
