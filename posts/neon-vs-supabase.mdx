...
- Supabase follows PostgreSQL’s robust security features but does not specifically mention SOC 2 compliance.
...
In contrast, Supabase provides automated daily backups and PITR, with daily backups accessible for 7 days on Pro plans and 30 days on Enterprise plans.
<Callout>
...
4. **[State of Serverless Databases 2024](https://www.devtoolsacademy.com/blog/state-of-databases-2024)**

> The old serverless database debate with a fresh perspective.
