...
We need to extract the **Publishable Key** from the Clerk dashboard and add inside the **.env.local** file to aid in the auth.

This key is present at **Configure -> Developers -> API Keys**
