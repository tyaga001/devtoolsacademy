...
In this post, I'm shared my overview of the databases that pair exceptionally well with modern app architectures, focusing on serverless.
...
<Callout>
    This is fully opinionated and I tried to be as unbiased as possible and open for feedback and learning. feel free to add comments and let's discuss.
</Callout>
