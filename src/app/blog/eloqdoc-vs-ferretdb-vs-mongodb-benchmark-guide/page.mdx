...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Google Cloud pd-balanced persistent disk</td>
    </tr>
    <tr>
      <td><strong>FerretDB (PostgreSQL)</strong></td>
      <td>Google Cloud pd-balanced persistent disk</td>
    </tr>
    <tr>
      <td><strong>EloqDoc</strong></td>
      <td>2.9 TB Titanium SSD (standardlssd) - used as the EloqDoc local cache</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>Local NVMe (Titanium SSD)</strong></td>
      <td>750k read / 500k write</td>
      <td>3000 MiB/s read / 2500 MiB/s write</td>
    </tr>
    <tr>
      <td><strong>3.0 TB pd-balanced Persistent Disk (Google Cloud)</strong></td>
      <td>3000 read / 3000 write</td>
      <td>~140 MiB/s</td>
    </tr>
  </tbody>
</table>
