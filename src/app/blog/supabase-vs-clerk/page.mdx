...
import Img45 from "./img_45.png"
import Img46 from "./img_46.png"

import Img48 from "./img_48.png"
import Img49 from "./img_49.png"
import Img50 from "./img_50.png"
import Img51 from "./img_51.png"
import Img52 from "./img_52.png"
import Img53 from "./img_53.png"
import Img54 from "./img_54.png"
import Img55 from "./img_55.png"

import Img57 from "./img_57.png"
import Img58 from "./img_58.png"
import Img59 from "./img_59.png"
import Img60 from "./img_60.png"
import Img61 from "./img_61.png"
import Img62 from "./img_62.png"
import Img63 from "./img_63.png"
import Img64 from "./img_64.png"
...
This is the next post in a series of **awesome developer tools** I intend to write about. In earlier posts I talk about Strean, CodeRabbit, Cursor, Neon, Supabase, Postgres and MongoDB it's worth revisiting:
...
4. [Cody vs. Cursor](https://www.devtoolsacademy.com/blog/cody-vs-cursor-choosing-the-right-ai-code-assistant-for-your-development-workflow/)
5. [Stream vs. Twilio](https://www.devtoolsacademy.com/blog/stream-vs-twilio/)
6. [CodeRabbit vs. Other AI Code Review Tools](https://www.devtoolsacademy.com/blog/coderabbit-vs-others-ai-code-review-tools/)
7. [Cursor vs Windsurf ](https://www.devtoolsacademy.com/blog/cursor-vs-windsurf/)
...
<Image src={Img21} alt="Supabase" width={1200} height={600} />

> **Clerk** - You can sign up via **GitHub**, **Google** or an **Existing email/password combination**.

<Image src={Img22} alt="Clerk-Auth" width={1200} height={600} />
...
<Image src={Img23} alt="Supabase-Org" width={1200} height={600} />
...
<Image src={Img24} alt="Supabase-Create-Account" width={1200} height={600} />
...
<Image src={Img25} alt="Supabase-Dashboard" width={1200} height={600} />
...
<Image src={Img26} alt="Supabase-API-Keys" width={1200} height={600} />
...
<Image src={Img27} alt="Clerk-Login-Page" width={1200} height={600} />

> Great - You've created your Clerk app and now you'll see your shiny new **Dashboard**.

<Image src={Img28} alt="Clerk-Auth-Dashboard" width={1200} height={600} />
...
<Image src={Img32} alt="Supabase-create-new-users" width={1200} height={600} />
...
<Image src={Img34} alt="Clerk-Create-Users" width={1200} height={600} />

> Let's create a user -> fill in the details -> Check the Ignore password policies checkbox for simplicity purposes.

<Image src={Img35} alt="Clerk-How-to-create-a-user" width={1200} height={600} />

The user gets added to the platform instantly.

<Image src={Img36} alt="Clerk-user-dashboard" width={1200} height={600} />
...
<Image src={Img37} alt="Supabase-API-Configuration" width={1200} height={600} />
...
<Image src={Img38} alt="Supabase-React-App-Local" width={1200} height={600} />
...
<Image src={Img39} alt="Supabase-Local-React-APp" width={1200} height={600} />
...
<Image src={Img40} alt="Clerk-API-Keys-Dashboard" width={1200} height={600} />
...
<Image src={Img41} alt="Clerk-SignIn-Page" width={1200} height={600} />
...
<Image src={Img42} alt="Clerk-Auth-Page-Success" width={1200} height={600} />
...
<Image src={Img43} alt="Swagger-UI-API-Test" width={1200} height={600} />
...
<Image src={Img44} alt="API" width={1200} height={600} />

API data successfully appears on the UI.

<Image src={Img45} alt="API_Data" width={1200} height={600} />
...
<Image src={Img46} alt="Clerk-Default-Secret-Key" width={1200} height={600} />
...
<Image src={Img46} alt="Clerk-API-keys" width={1200} height={600} />
...
<Image src={Img48} alt="Clerk-API" width={1200} height={600} />
...
<Image src={Img49} alt="Supabase-OAuth" width={1200} height={600} />
...
<Image src={Img50} alt="Supabase-OAuth-List" width={1200} height={600} />
...
<Image src={Img51} alt="GitHub-OAuth-Apps" width={1200} height={600} />

<Image src={Img52} alt="OAuth-Github-app" width={1200} height={600} />
...
<Image src={Img53} alt="Github-auth-demo-app" width={1200} height={600} />
...
<Image src={Img54} alt="Supabase" width={1200} height={600} />
...
<Image src={Img55} alt="Github-app" width={1200} height={600} />
...
<Image src={Img57} alt="Clerk-GitHub-OAuth" width={1200} height={600} />

<Image src={Img58} alt="Clerk-GitHub" width={1200} height={600} />

GitHub will be added as an ´OAuth` provider.

<Image src={Img59} alt="Clerk-Github" width={1200} height={600} />

Let's run the `React` app and click the `Signin` button, we will see GitHub also as a login provider.

<Image src={Img60} alt="Clerk-Github" width={1200} height={600} />

Click on `GitHub` link, and it will ask to authorize Clerk with the logged in `GitHub` user id.

<Image src={Img61} alt="Clerk-Github-providor" width={1200} height={600} />

Upon authorizing it, we will be redirected back to the Success page with the `UserButton` component populated.

<Image src={Img62} alt="Clerk-AUth" width={1200} height={600} />
...
<Image src={Img63} alt="Clerk" width={1200} height={600} />
