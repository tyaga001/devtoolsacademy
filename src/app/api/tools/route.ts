...
export async function POST(req: NextRequest) {
  try {
    const tools = [
      ...
      {
        "name": "Appsmith",
        "headline": "Build custom applications more quickly and securely with the leader in open-source low-code development.",
      ...
      {
        "name": "Formbricks",
        "headline": "Gather feedback on websites, apps and everywhere else to understand what your customers need.",
