...
export const ChatSuggestions: React.FC<BlogChatSuggestionProps> = ({ title, description, handleSend }) => {
    ...
    return (
        <div className='w-full flex py-6 flex-col gap-6 items-center'>
            <h1 className='text-2xl  font-[300] text-white/70'>Go Ahead. Ask <b className='text-white font-medium'>AI</b> about anything related to this <b className='text-white font-medium'>Blog</b>.</h1>
