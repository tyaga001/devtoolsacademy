  ...
  return (
    <section className="mt-20 border-t border-dashed border-neutral-100/15 pt-12">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {relatedPosts.map((post) => (
          <Link
            key={post.slug}
            href={`/blog/${post.slug}`}
            className="group block overflow-hidden border border-dashed border-neutral-100/10 bg-gradient-to-br from-neutral-900/50 to-neutral-900/30 backdrop-blur-sm transition-all duration-300 hover:border-neutral-100/20 hover:from-neutral-900/70 hover:to-neutral-900/50 no-underline"
          >
            <div className="relative h-min overflow-hidden">
              <Image
                ...
                height={500}
                width={400}
                className="transition-transform duration-500 group-hover:scale-110 m-0 p-0"
              />
      ...
      <div className="mt-8 text-center">
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 border border-dashed border-neutral-700 bg-transparent px-6 py-3 text-sm font-medium text-neutral-300 transition-all hover:border-neutral-600 hover:bg-neutral-800/50 no-underline"
        >
