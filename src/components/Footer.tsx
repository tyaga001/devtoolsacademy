...
const BlogPostList: React.FC = () => (
    <div>
        <h4 className="text-xl font-semibold mb-4 text-yellow-400">Other Blog Posts</h4>
        <ul className="space-y-3">
            {recentBlogPosts.map((post) => (
                <motion.li key={post.url} whileHover={{x: 5}} transition={{type: "spring", stiffness: 300}}>
                    <a
                        href={post.url}
                        target="_blank"
...
const ProgressBar: React.FC<{ progress: number }> = ({progress}) => (
    <div className="text-center text-gray-400 border-t border-gray-700 pt-8 mb-8">
        <p className="mt-4">Progress on the upcoming blog post: <span
            className="font-bold text-yellow-400">{progress}%</span></p>
...
const WebsitePromo: React.FC = () => (
    ...
    >
        ...
        <p className="text-gray-300 mb-3">Explore more about my writing, SaaS dev tools and my journey in the
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    >
                        ...
                        <p className="text-gray-300">Choose the Right Dev Tools for Your SaaS.</p>
                    ...
                    >
                        <h4 className="text-xl font-semibold mb-4 text-yellow-400">Connect With Me</h4>
