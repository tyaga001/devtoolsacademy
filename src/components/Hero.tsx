...
const Hero: React.FC = () => {
  return (
    <section className="relative grid place-content-center py-48">
      <div className="grid-background absolute inset-0 size-full opacity-5" />
      <div className="flex  flex-col px-4 text-center text-neutral-200 md:px-0">
        ...
        <div>
          <Link
            href="/blog"
            className="rounded-md bg-neutral-200 px-5 py-3 text-lg font-medium text-neutral-800 outline-none hover:bg-neutral-300 focus:bg-neutral-300"
          >
            Start Reading
          </Link>
        </div>
