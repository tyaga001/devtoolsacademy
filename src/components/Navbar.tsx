      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          <Link href="/">
            ...
            >
              <path d="M159 53H106L159 0H212V53L159 106V53Z" fill="white" />
              <path d="M53 53H0L53 0H106V53L53 106V53Z" fill="white" />
              <path
                d="M159 159H106L159 106H212V159L159 212V159Z"
                fill="white"
              />
              <path d="M53 159H0L53 106H106V159L53 212V159Z" fill="white" />
              <path
