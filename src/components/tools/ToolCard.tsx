...
const ToolCard: React.FC<ToolCardProps> = ({ tool }) => {
  return (
    <Link href={`/tools/${encodeURIComponent(tool.name)}`} className="block">
      <Card className="relative size-full max-w-sm overflow-hidden border-neutral-100/10 opacity-90 ring-[#1C1C1C]/50 transition-all hover:opacity-100 hover:ring">
