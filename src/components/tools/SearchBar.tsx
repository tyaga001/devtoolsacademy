  ...
  return (
    <div className="relative flex-grow w-full">
      <input
        ...
        className="w-full h-12 bg-[#141414] border border-white/20 rounded-full pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-white/30 transition-all duration-200"
      />
