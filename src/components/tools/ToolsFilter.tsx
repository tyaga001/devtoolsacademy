    ...
    <div className="mx-auto w-full max-w-4xl px-4 md:px-0">
      <div className="flex w-full flex-col border border-dashed border-neutral-100/15 text-neutral-200">
        <div className="flex w-full flex-col-reverse md:flex-row">
          <div className="flex-1 border-t border-dashed border-neutral-100/15 md:border-t-0">
            <SearchBar />
          </div>
          <div className="flex items-center justify-end">
            <Popover>
              <PopoverTrigger className="flex w-full items-center justify-around gap-2 border-r border-dashed border-neutral-100/15 bg-neutral-900 px-2 py-3 outline-none transition-colors duration-200 hover:bg-neutral-100/10 focus:bg-neutral-100/10 md:w-fit md:border-l md:px-4 md:py-3">
